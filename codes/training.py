...
def run_trial(type,re, id):
    ...
    '''
    flag = re[id] %2
    show_sound(time=1.0, flag=flag)
    if type == 'RS1':
        show_pic(focus,time=1.0,id=1)
        show_RS(RS1, time=10.0, id=id)            #原本为30s
    elif type == 'RS2':
        show_pic(focus,time=1.0,id=1)
...
def domi(type):
    ...
    show_text('natural rate', time = 2.0)
    run_trial(type,re, id=10)
    show_text('fast rate', time = 2.0)
    run_trial(type,re, id=11)
    show_text('fast rate', time = 2.0)
    run_trial(type,re, id=12)
    show_text('fast rate', time = 2.0)
    run_trial(type,re, id=13)
    show_text('fast rate', time = 2.0)
    run_trial(type,re, id=14)
    show_text('slow rate', time = 2.0)
    run_trial(type,re, id=15)
    show_text('slow rate', time = 2.0)
    run_trial(type,re, id=16)
    show_text('slow rate', time = 2.0)
    run_trial(type,re, id=17)
    show_text('slow rate', time = 2.0)
    run_trial(type,re, id=18)
...
show_text('training stimu 1', time=3.0)
domi('RS1')
