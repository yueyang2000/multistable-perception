...
sound_1 = sound.Sound('c', secs=0.5, stereo=True, hamming=True,
    name='sound_1')
sound_1.setVolume(1)
sound_2 = sound.Sound('F', secs=0.5, stereo=True, hamming=True,
    name='sound_2')
sound_2.setVolume(1)
sound_3 = sound.Sound('B', secs=0.5, stereo=True, hamming=True,
    name='sound_3')
sound_3.setVolume(1)
...
def show_sound(time=1.0, flag=0):
    sound_1.setSound('C', secs=0.5, hamming=True)
    sound_1.setVolume(1, log=False)
    sound_2.setSound('F', secs=0.5, hamming=True)
    sound_2.setVolume(1, log=False)
    sound_3.setSound('B', secs=0.5, hamming=True)
    sound_3.setVolume(1, log=False)

    sound_signal=[1,2,3]
    random.shuffle(sound_signal)
    for flag in sound_signal:
        if flag == 1:
            cue = sound_1
        elif flag ==2:
            cue = sound_2
...
def run_trial(type, id):
    ...
    if id==1:
        ...
        #show_sound(time=1.0, flag = 2)
    elif id==3:
        show_text('slow rate', time = 2.0)
        # show_pic(shun,time=1.0,id=1)
        #show_sound(time=1.0, flag = 3)
    elif id==4:
        show_text('natural rate', time = 2.0)
        # show_pic(shun,time=1.0,id=1)
        #show_sound(time=1.0, flag = 3)
    ...
    if type == 'RS1':
        show_RS(RS1, time=30.0, id=id)            #原本为30s
    elif type == 'RS2':
        show_RS(RS2, time=30.0,id=id)
    elif type == 'QD':
        show_QD(time=30.0,id=id)

    show_text1('rest', time = 30.0) # rest for 25s
...
# #mymouse.setVisible(visible=0)
# domi('RS1')
# #mymouse.setVisible(visible=1)
# show_text1('Block 1 rest', time = 60.0) # block之间的大段rest
# #show_text('block 2', time=3.0)
# #mymouse.setVisible(visible=0)
# #domi('RS1')
# #show_text1('Block 2 rest', time = 60.0) # block之间的大段rest
# #show_text('block 3', time=3.0)
# #mymouse.setVisible(visible=0)
# #domi('RS1')
# #show_text1('Block 3 rest', time = 60.0) # block之间的大段rest
# show_text('block 2', time=3.0)
# #mymouse.setVisible(visible=0)
# domi('RS2')
# #mymouse.setVisible(visible=1)
# show_text1('Block 2 rest',time = 60.0)
#show_text('block 5', time=3.0)
#mymouse.setVisible(visible=0)
#domi('RS2')
#mymouse.setVisible(visible=1)
#show_text1('Block 5 rest',time = 60.0)
#show_text('block 6', time=3.0)
#mymouse.setVisible(visible=0)
#domi('RS2')
#mymouse.setVisible(visible=1)
#show_text1('Block 6 rest',time = 60.0)
show_text('block 3', time=3.0)
#mymouse.setVisible(visible=0)
domi('QD')
#mymouse.setVisible(visible=1)
show_text1('Block 3 rest',time = 60.0)
#show_text('block 8', time=3.0)
#mymouse.setVisible(visible=0)
#domi('QD')
#mymouse.setVisible(visible=1)
#show_text1('Block 8 rest',time = 60.0)
#show_text('block 9', time=3.0)
#mymouse.setVisible(visible=0)
#domi('QD')
#mymouse.setVisible(visible=1)
#show_text1('Block 9 rest',time = 60.0)
